...
echo "----------------------------------------------------"
echo "Configure the following systemd services:"
echo "  - /etc/systemd/system/pdf-audio-backend.service  (FastAPI web service)"
echo "  - /etc/systemd/system/pdf-audio-worker.service   (Background task worker)"
echo ""
echo "Templates for systemd service configurations are saved in your report file:"
