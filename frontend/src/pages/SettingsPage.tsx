  ...
  return (
    <section className="page settings-page">
      ...
      <div className="card form-grid">
        ...
        <button onClick={() => preview('english')}>Preview English</button><button onClick={() => preview('chinese')}>Preview Chinese</button>
      </div>
      <div className="card form-grid">
        ...
        <label><input type="checkbox" checked={Boolean(settings.dark_mode)} onChange={(e) => set('dark_mode', e.target.checked)} /> Dark mode</label>
        <button onClick={clearCache}>Clear server cache</button>
      </div>
